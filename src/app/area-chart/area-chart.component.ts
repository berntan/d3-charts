...
export class AreaChartComponent implements OnInit, OnChanges {
  ...
  g; // SVG Group element
  private colorScale: d3.ScaleOrdinal<string, string>;            // D3 color provider
  x: d3.ScaleLinear<number, number>; // X-axis graphical coordinates
  y: d3.ScaleLinear<number, number>; // Y-axis graphical coordinates
  ...
  private histogram: d3.HistogramGeneratorNumber<number, number>; // For D3 histogram function
